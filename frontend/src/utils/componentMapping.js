...
export const componentMapping = {
  ...
  reports: {
    componentPath: 'components/Reports.jsx',
    routePath: '/reports',
  ...
  'employee-reports': {
    componentPath: 'components/EmployeeReports.jsx',
    routePath: '/employee-reports',
    componentName: 'EmployeeReports',
    description: 'Employee Personal Reports',
    icon: Description,
  },
  'absences-report': {
    componentPath: 'components/LEAVE/AbsencesReport.jsx',
    routePath: '/absences-report',
    componentName: 'AbsencesReport',
    description: 'Absences Report',
    icon: EventNote,
  },
  'attendance-adjustment-reports': {
    componentPath: 'components/ATTENDANCE/AttendanceAdjustmentReports.jsx',
    routePath: '/attendance-adjustment-reports',
    componentName: 'AttendanceAdjustmentReports',
    description: 'Attendance Adjustment Reports',
    icon: EventNote,
  },
  'assessment-clearance': {
    componentPath: 'components/FORMS/AssessmentClearance.jsx',
    routePath: '/assessment-clearance',
    componentName: 'AssessmentClearance',
    description: 'Assessment Clearance Form',
    icon: Assignment,
  },
  clearance: {
    componentPath: 'components/FORMS/Clearance.jsx',
    routePath: '/clearance',
  ...
  'clearance-back': {
    componentPath: 'components/FORMS/ClearanceBack.jsx',
    routePath: '/clearance-back',
    componentName: 'ClearanceBack',
    description: 'Clearance Form (Back)',
    icon: Assignment,
  },
  'faculty-clearance': {
    componentPath: 'components/FORMS/FacultyClearance.jsx',
    routePath: '/faculty-clearance',
    componentName: 'FacultyClearance',
    description: 'Faculty Clearance Form',
    icon: Assignment,
  },
  'faculty-clearance-70-days': {
    componentPath: 'components/FORMS/FacultyClearance70Days.jsx',
    routePath: '/faculty-clearance-70-days',
    componentName: 'FacultyClearance70Days',
    description: 'Faculty Clearance (70 Days)',
    icon: Assignment,
  },
  'hrms-request-forms': {
    componentPath: 'components/FORMS/HRMSRequestForms.jsx',
    routePath: '/hrms-request-forms',
    componentName: 'HRMSRequestForms',
    description: 'HRMS Request Forms',
    icon: Assignment,
  },
  'individual-faculty-loading': {
    componentPath: 'components/FORMS/IndividualFacultyLoading.jsx',
    routePath: '/individual-faculty-loading',
    componentName: 'IndividualFacultyLoading',
    description: 'Individual Faculty Loading',
    icon: Assignment,
  },
  'in-service-training': {
    componentPath: 'components/FORMS/InServiceTraining.jsx',
    routePath: '/in-service-training',
    componentName: 'InServiceTraining',
    description: 'In-Service Training Form',
    icon: Assignment,
  },
  'leave-card': {
    componentPath: 'components/FORMS/LeaveCard.jsx',
    routePath: '/leave-card',
    componentName: 'LeaveCard',
    description: 'Leave Card Form',
    icon: Assignment,
  },
  'leave-card-back': {
    componentPath: 'components/FORMS/LeaveCardBack.jsx',
    routePath: '/leave-card-back',
    componentName: 'LeaveCardBack',
    description: 'Leave Card Form (Back)',
    icon: Assignment,
  },
  'leave-form': {
    componentPath: 'components/FORMS/Leave.jsx',
    routePath: '/leave-form',
    componentName: 'LeaveForm',
    description: 'Leave Application Form',
    icon: Assignment,
  },
  'locator-slip': {
    componentPath: 'components/FORMS/LocatorSlip.jsx',
    routePath: '/locator-slip',
    componentName: 'LocatorSlip',
    description: 'Locator Slip Form',
    icon: Assignment,
  },
  'permission-to-teach': {
    componentPath: 'components/FORMS/PermissionToTeach.jsx',
    routePath: '/permission-to-teach',
    componentName: 'PermissionToTeach',
    description: 'Permission to Teach Form',
    icon: Assignment,
  },
  'request-for-id': {
    componentPath: 'components/FORMS/RequestForID.jsx',
    routePath: '/request-for-id',
    componentName: 'RequestForID',
    description: 'Request for ID Form',
    icon: Assignment,
  },
  'saln-front': {
    componentPath: 'components/FORMS/SalnFront.jsx',
    routePath: '/saln-front',
    componentName: 'SalnFront',
    description: 'SALN Form (Front)',
    icon: Assignment,
  },
  'saln-back': {
    componentPath: 'components/FORMS/SalnBack.jsx',
    routePath: '/saln-back',
    componentName: 'SalnBack',
    description: 'SALN Form (Back)',
    icon: Assignment,
  },
  'scholarship-agreement': {
    componentPath: 'components/FORMS/ScholarshipAgreement.jsx',
    routePath: '/scholarship-agreement',
    componentName: 'ScholarshipAgreement',
    description: 'Scholarship Agreement Form',
    icon: Assignment,
  },
  subject: {
    componentPath: 'components/FORMS/SubjectStillToBeTaken.jsx',
    routePath: '/subject',
    componentName: 'SubjectStillToBeTaken',
    description: 'Subject Still To Be Taken',
    icon: Assignment,
  },
};
