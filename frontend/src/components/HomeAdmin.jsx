  ...
  return (
    ...
    >
      ...
      {activeTab === 0 && (
        ...
        >
          {/* Header row: label + month dropdown */}
          <Box
            sx={{
              display: "flex",
              alignItems: "center",
          ...
          {/* ── Payslip breakdown: gross → deductions → net ── */}
          {payrollData &&
            (() => {
              const gross =
                parseFloat(
                  payrollData.grossPay ??
                    ...
                    payrollData.basic_pay ??
                    parseFloat(payrollData.pay1st || 0) +
                      parseFloat(payrollData.pay2nd || 0),
                ) || 0;
              const deductions =
                parseFloat(
    ...
    try {
      ...
      const filtered = Array.isArray(notifRes.data)
        ? notifRes.data.filter(
            (n) => String(n.employeeNumber).trim() === String(empNum).trim(),
          )
        : [];
                ...
                {selectedAnnouncement &&
                  (() => {
                    ...
                    const accentColor = isHoliday
                      ? "#FB8C00" // Orange for Holiday
                      : isSuspension
                        ? "#B71C1C" // Red for Suspension
                        : "#1976D2"; // Blue for Announcement

                    const badgeBg = `${accentColor}55`; // translucent background
                        ...
                        <Box
                          sx={{
                            ...
                            "&::-webkit-scrollbar-thumb": {
                              ...
                              borderRadius: 2,
                              "&:hover": {
                                bgcolor: `${settings.primaryColor}50`,
                              },
                            },
                          }}
                        >
                  ...
                  {(!Array.isArray(notifications) ||
                    ...
                    <Box sx={{ textAlign: "center", py: 8 }}>
                      <NotificationsIcon
                        sx={{
                          fontSize: 80,
                          color: `${settings.primaryColor}33`,
                        }}
                      />
                      <Typography
                        sx={{
