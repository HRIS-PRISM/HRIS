    ...
    <Box sx={{ pt: 4, px: 4, mx: 'auto', maxWidth: '1600px' }}>
      ...
      <Box
        sx={{
          ...
          gap: 1,
          pb: 1.5,
          animation: 'adminPulse 2s ease-in-out 0.05s infinite',
        }}
      >
        {[...Array(5)].map((_, i) => (
          ...
          {['Tasks', 'Events'].map((label, i) => {
            ...
            return (
              ...
              >
                ...
                <Typography
                  sx={{ fontSize: '0.72rem', fontWeight: 600, lineHeight: 1 }}
                >
                  {label}
                </Typography>
      ...
      {activeTab === 0 && (
        <Box
          ...
          sx={{
            ...
            '&:hover': { background: `${settings.primaryColor}08` },
          }}
        >
          <Box
            sx={{
          ...
          >
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
              <Receipt
                sx={{ color: settings.textPrimaryColor, fontSize: 13 }}
              />
              <Typography
                sx={{
                  fontWeight: 700,
            ...
            <FormControl
              ...
              sx={{
                ...
                '& .MuiOutlinedInput-root': {
                  ...
                  height: 24,
                  color: settings.textPrimaryColor,
                  '& fieldset': { borderColor: `${settings.primaryColor}40` },
                  '&:hover fieldset': { borderColor: settings.primaryColor },
                    ...
                    sx={{
                      ...
                      bgcolor:
                        payslipMonth === i
                          ...
                          : 'transparent',
                      '&:hover': { bgcolor: `${settings.primaryColor}1A` },
                    }}
                  >
                    {name}
                  </MenuItem>
          ...
          {!payrollData && (
            <Box
              sx={{
                ...
                py: 0.5,
                borderRadius: 1.5,
                bgcolor: `${settings.primaryColor}08`,
            ...
            >
              ...
              >
                No payslip released for {monthNames[payslipMonth]}
              </Typography>
            </Box>
          )}
          <Box
          ...
          >
            <ArrowForward
              sx={{ fontSize: 11, color: settings.textPrimaryColor }}
            />
            <Typography
              sx={{
                fontSize: '0.6rem',
        ...
        >
          ...
          >
            ...
            {!leaveLoading && leaveCredits.length > 0 && (
              <Chip
                label={`${totalLeave.toFixed(1)} Days`}
                size="small"
                sx={{
                  bgcolor: settings.primaryColor,
                  color: '#fff',
          ...
          >
            {leaveLoading ? (
              ...
              >
                ...
                />
                <Typography
                  sx={{ color: settings.textPrimaryColor, fontSize: '0.7rem' }}
                >
                  Loading...
                </Typography>
              </Box>
        ...
        <Box sx={{ pt: 4, px: 4, mx: 'auto', maxWidth: '1600px' }}>
          ...
          >
            {STAT_CARDS(settings).map((card, index) => (
              <Box
                key={card.label}
                sx={{ flex: '1 1 0', maxWidth: '19%', minWidth: '140px' }}
              >
                <CompactStatCard
                  card={card}
                  index={index}
          ...
          <Grid container spacing={2} sx={{ flex: 1, minHeight: 0 }}>
            ...
            <Grid
              ...
              sx={{
                minHeight: 0,
                height: { xs: '52vw', md: 'calc(100vh - 362px)' },
                display: 'flex',
                flexDirection: 'column',
              }}
            >
