                  ...
                  {Array.from({ length: 8 }).map((_, i) => (
                    <Box
                      ...
                      sx={{
                        display: "grid",
                        gridTemplateColumns:
                          "50px 110px 1fr 130px 130px 120px 80px",
                        gap: 1,
                        alignItems: "center",
                        py: 0.45,
                      }}
...
const DailyTimeRecordFaculty = () => {
  ...
  const formatMonth = (dateString) => {
    ...
    return new Date(2000, parseInt(month) - 1, 1)
  ...
  const renderDTRRows = (sourceRecords, type) =>
    Array.from({ length: 31 }, (_, i) => {
      ...
      const record = sourceRecords.find(
        (r) => getDateDay(normalizeRecord(r).date) === day,
      );
      ...
      return (
<tr key={i} style={{ height: '16px', maxHeight: '16px' }}>
            <td
    ...
    <Fade in timeout={500}>
      <Box>
        ...
        <LoadingOverlay
          ...
          message={
            loadPhase ? `Batch load — ${loadPhase}` : "Batch load — Loading…"
          }
        />
                    ...
                    {selectedMonth !== null && records.length > 0 && (
                      ...
                      >
                        ...
                        <Typography sx={{ fontSize: "0.7rem", color: T.faint }}>
                          Download generates a PDF of the DTR for {employeeName}{" "}
                  ...
                  <>
                    ...
                    {allUsersDTR.length > 0 ? (
                      ...
                      >
                        ...
                        >
                          {loadingAllUsers ? (
                            <MCircularProgress sx={{ color: T.accent }} />
                          ) : (
                            <PrintIcon
                              sx={{ fontSize: 32, color: alpha(T.accent, 0.3) }}
                            />
