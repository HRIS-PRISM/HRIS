  ...
  return (
    <Box sx={{ width: '49%', border, borderRadius: '2px', overflow: 'hidden', bgcolor: 'white', display: 'flex', flexDirection: 'column' }}>
      ...
      <Box sx={{ p: '12px 10px 8px', borderBottom: border, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '5px' }}>
        ...
        {/* Two-line title: DAILY TIME RECORD + SERVICE CREDITS */}
        <S w="62%" h={14} r={4} accent={accent} sx={{ mt: '3px' }} />
        <S w="55%" h={14} r={4} accent={accent} sx={{ mb: '3px' }} />
...
const DTRServiceCreditsWireframeLoading = ({
  accentColor    = '#6d2323',
  primaryColor   = '#FEF9E1',
  ...
  return (
    <>
            ...
            <Box sx={{ p: 5, background: grad }}>
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                  {/* Integrity badge + Service Credits chip + icon button */}
      ...
      {/* 4. FAB buttons — fixed bottom-right, same as real layout */}
...
const DailyTimeRecordServiceCredits = () => {
  ...
  if (pageLoading || accessLoading) return (
    <DTRServiceCreditsWireframeLoading
                  ...
                  <Box display="flex" alignItems="center" justifyContent="space-between" position="relative" zIndex={1}>
                    <Box display="flex" alignItems="center">
                      ...
                      <Box>
                        ...
                        <Typography variant="body1" sx={{ opacity: 0.8, fontWeight: 400, color: textPrimaryColor }}>Filter your service credits DTR records by date</Typography>
                      </Box>
                    </Box>
                    <Box display="flex" alignItems="center" gap={2}>
                      <IntegrityBadge />
                      <Chip label="Service Credits" size="small" sx={{ bgcolor: alpha(accentColor,0.15), color: textPrimaryColor, fontWeight: 500, '& .MuiChip-label': { px: 1 } }} />
