...
const DailyTimeRecordOvertime = () => {
  ...
  const {
    ...
    error: accessError,
  } = usePageAccess('daily-time-record-overtime');
  ...
  const fetchRecords = async () => {
    try {
      ...
      // Filter to show only records with OVERTIME special times
                      ...
                      >
                        ...
                        <tbody>
                          {Array.from({ length: 31 }, (_, i) => {
                            ...
                            const officialTmsForDate =
                              getOfficialTimesForDate(fullDate);
