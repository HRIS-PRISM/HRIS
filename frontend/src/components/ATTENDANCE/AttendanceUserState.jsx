...
const determineAttendanceStateWithType = (
  ...
  if (!officialTimeRecord || !attendanceRecord) {
    console.log('No official time data found for record:', attendanceRecord);
    return { state: attendanceRecord?.AttendanceState || null, type: null };
  }

  const attendanceTime = attendanceRecord.Time;

  console.log('Checking attendance time:', attendanceTime);
  console.log('Official time data:', officialTimeRecord);
  ...
  // NO MATCH - Return "Uncategorized" (state 0 or null, with empty type)
