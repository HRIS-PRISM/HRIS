 ...
 *  - Signature area is blank (no e-signature label)
 */
          ...
          <table style={{ border: '1px solid black', borderCollapse: 'collapse', fontFamily: 'Arial, Helvetica, sans-serif', width: '8in', tableLayout: 'fixed' }}>
            <tbody>
              ...
              <tr>
                ...
                {/* ── 2017: mm/dd/yyyy ── */}
                <td colSpan="2" style={{ ...cellGray, height: '0.2in', textAlign: 'center' }}>INCLUSIVE DATES<br />(mm/dd/yyyy)</td>
              ...
              <tr>
                ...
                {/* ── 2017: mm/dd/yyyy ── */}
                <td colSpan="2" style={{ ...cellGray, height: '0.4in', fontSize: '55%', textAlign: 'center' }}>INCLUSIVE DATES OF<br />ATTENDANCE<br />(mm/dd/yyyy)</td>
              ...
              {/* ── 2017: blank signature area (no e-signature note) ── */}
              <tr>
