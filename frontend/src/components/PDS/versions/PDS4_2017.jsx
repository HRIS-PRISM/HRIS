 ...
 *  - References section: "ADDRESS" and "TEL. NO." (not Office/Residential + Contact/Email)
 *  - Photo box: "ID picture taken within the last 6 months 4.5 cm. X 3.5 cm (passport size) Computer generated or photocopied picture is not acceptable"
 *  - Signature box label: blank (no e-signature note)
 */
          ...
          <thead>
            <table style={{ border: '1px solid black', borderCollapse: 'collapse', fontFamily: 'Arial, Helvetica, sans-serif', width: '8in', tableLayout: 'fixed', marginTop: '-5px' }}>
              <tbody>
                ...
                {/* ── 41. REFERENCES — 2017 uses ADDRESS + TEL. NO. ── */}
                <tr>
                ...
                <tr>
                  ...
                  {/* ── 2017 column headers ── */}
                  <td colSpan="5" style={{ ...cellGray, height: '0.25in', textAlign: 'center' }}>ADDRESS</td>
                  <td colSpan="2" style={{ ...cellGray, height: '0.25in', textAlign: 'center' }}>TEL. NO.</td>
                </tr>
                {[0, 1, 2].map((i) => (
                  <tr key={i}>
                    <td colSpan="7" style={{ ...cellWhite, height: '0.25in' }}>&nbsp;</td>
                    <td colSpan="5" style={{ ...cellWhite, height: '0.25in' }}>&nbsp;</td>
                    <td colSpan="2" style={{ ...cellWhite, height: '0.25in' }}>&nbsp;</td>
                  </tr>
                ))}
                  ...
                  <td colSpan="18" style={{ height: '1.50in', fontSize: '50%', border: '0px 1px 0px 1px solid black' }}>
                    <div style={{ position: 'relative', top: '0.06in', float: 'left' }}>
                      <table style={{ border: '1px solid black', borderCollapse: 'collapse', fontFamily: 'Arial, Helvetica, sans-serif', width: '2.9in', height: '1.1in', tableLayout: 'fixed' }}>
                        <tbody>
                          <tr><td style={{ height: '0.35in', fontSize: '47.5%', backgroundColor: 'lightgray', border: '1px solid black', textAlign: 'center' }}>
                    ...
                    <div style={{ position: 'relative', top: '0.08in', left: '0.3in', float: 'left' }}>
                      <table style={{ border: '1px solid black', borderCollapse: 'collapse', fontFamily: 'Arial, Helvetica, sans-serif', width: '2.9in', height: '1.1in', tableLayout: 'fixed' }}>
                        <tbody>
                          ...
                          {/* ── 2017: blank signature label ── */}
                          <tr><td style={{ height: '0.11in', fontSize: '58%', backgroundColor: 'lightgray', border: '1px solid black', textAlign: 'center' }}>Signature (Sign inside the box)</td></tr>
