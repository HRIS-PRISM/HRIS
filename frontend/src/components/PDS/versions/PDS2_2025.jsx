 ...
 *  - REMOVED: MONTHLY SALARY column
 *  - REMOVED: SALARY/JOB/PAY GRADE column
        ...
        <div style={{ overflow: 'hidden', padding: '0.25in', width: '8in', height: '13.1in' }}>
          <table style={{ border: '1px solid black', borderCollapse: 'collapse', fontFamily: 'Arial, Helvetica, sans-serif', width: '8in', tableLayout: 'fixed' }}>
            <tbody>
              ...
              {/* V. WORK EXPERIENCE — 2025: no Monthly Salary / Pay Grade columns */}
              ...
              <tr>
                ...
                <td colSpan="3" rowSpan="2" style={{ ...cellGray, height: '0.3in', textAlign: 'center' }}>INCLUSIVE DATES<br />(dd/mm/yyyy)</td>
                <td colSpan="6" rowSpan="3" style={{ ...cellGray, height: '0.3in', textAlign: 'center' }}>POSITION TITLE<br />(Write in full/Do not abbreviate)</td>
                <td colSpan="5" rowSpan="3" style={{ ...cellGray, height: '0.3in', textAlign: 'center' }}>DEPARTMENT / AGENCY / OFFICE / COMPANY<br />(Write in full/Do not abbreviate)</td>
              ...
              {normWork.map((w, i) => (
                <tr key={i}>
                  ...
                  <td colSpan="6" style={{ ...cellWhite, height: '0.3in' }}>{w?.workPositionTitle || ''}</td>
                  <td colSpan="5" style={{ ...cellWhite, height: '0.3in', fontSize: '62.5%' }}>{w?.workCompany || ''}</td>
