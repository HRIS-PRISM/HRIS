  ...
  <>
    ...
    <Box sx={{ py: 4, mt: -5, width: '100vw', maxWidth: '100%', position: 'relative', left: '50%', transform: 'translateX(-50%)' }}>
      <Box sx={{ px: { xs: 2, sm: 3, md: 6 }, mx: 'auto', maxWidth: '1800px' }}>
        ...
        {/* ── Header skeleton ── */}
        <Box sx={{ mb: 4, borderRadius: '20px', overflow: 'hidden', border: `1px solid ${alpha(accentColor, 0.1)}`, animation: 'lruPulse 2s ease-in-out infinite' }}>
          <Box sx={{ p: 5, background: `linear-gradient(135deg, ${primaryColor} 0%, ${secondaryColor} 100%)`, position: 'relative', overflow: 'hidden' }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'relative', zIndex: 1 }}>
              <Box sx={{ display: 'flex', alignItems: 'center' }}>
                ...
                <Box>
                  <SkeletonBox width={260} height={28} borderRadius={6} sx={{ mb: 1.5 }} />
        ...
        <Box sx={{ mb: 4, borderRadius: '20px', overflow: 'hidden', border: `1px solid ${alpha(accentColor, 0.1)}`, animation: 'lruPulse 2s ease-in-out 0.07s infinite' }}>
          {/* section header */}
          <Box sx={{ p: 3, pl: 4, background: `linear-gradient(135deg, ${primaryColor} 0%, ${secondaryColor} 100%)`, display: 'flex', alignItems: 'center', gap: 2, borderBottom: `1px solid ${alpha(accentColor, 0.08)}` }}>
            <Box sx={{ width: 36, height: 36, borderRadius: '50%', bgcolor: alpha(accentColor, 0.12), flexShrink: 0 }} />
            <Box>
              <SkeletonBox width={150} height={16} borderRadius={4} sx={{ mb: 0.5 }} />
          ...
          <Box sx={{ p: 3, bgcolor: alpha(primaryColor, 0.4) }}>
            <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1.5 }}>
              {[...Array(6)].map((_, i) => (
                <Box key={i} sx={{ display: 'flex', alignItems: 'center', gap: 1.5, px: 2, py: 1, borderRadius: '10px', bgcolor: 'rgba(255,255,255,0.8)', border: `1px solid ${alpha(accentColor, 0.08)}`, animation: `lruPulse 2s ease-in-out ${i * 0.06}s infinite`, minWidth: 160 }}>
                  <Box>
                    <SkeletonBox width={60} height={10} borderRadius={3} sx={{ mb: 0.5 }} />
                    <SkeletonBox width={80} height={16} borderRadius={3} />
                  </Box>
                  <Box sx={{ ml: 'auto', width: 40, height: 4, bgcolor: '#e0e0e0', borderRadius: 2, alignSelf: 'center' }}>
                    <Box sx={{ height: '100%', width: `${40 + i * 10}%`, bgcolor: alpha('#2E7D32', 0.4), borderRadius: 2 }} />
                  </Box>
                </Box>
              ))}
            </Box>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} lg={6}>
            <Box sx={{ borderRadius: '20px', overflow: 'hidden', border: `1px solid ${alpha(accentColor, 0.1)}`, animation: 'lruPulse 2s ease-in-out 0.10s infinite' }}>
              {/* panel header */}
              <Box sx={{ p: 4, background: `linear-gradient(135deg, ${primaryColor} 0%, ${secondaryColor} 100%)`, display: 'flex', alignItems: 'center', gap: 2, borderBottom: `1px solid ${alpha(accentColor, 0.08)}` }}>
              ...
              <Box sx={{ p: 4, display: 'flex', flexDirection: 'column', gap: 3 }}>
                {['Employee Number', 'Leave Type', 'Leave Date(s)', 'Selected Dates'].map((_, i) => (
                  <Box key={i}>
                    <SkeletonBox width={i === 2 ? 100 : i === 3 ? 110 : 130} height={12} borderRadius={3} sx={{ mb: 1 }} />
                    <Box sx={{ height: i === 3 ? 56 : 44, borderRadius: '12px', border: `1px solid ${alpha(accentColor, 0.15)}`, bgcolor: 'rgba(255,255,255,0.8)', display: 'flex', alignItems: 'center', px: 2, gap: 1 }}>
                      {i === 2 && <Box sx={{ width: 20, height: 20, borderRadius: '4px', bgcolor: alpha(accentColor, 0.15) }} />}
                      <SkeletonBox width={i === 2 ? 130 : '50%'} height={12} borderRadius={3} />
                    </Box>
                  </Box>
                ))}
                {/* Submit button */}
                <Box sx={{ height: 48, borderRadius: '12px', bgcolor: alpha(accentColor, 0.15), mt: 1 }} />
              </Box>
            </Box>
          </Grid>
          ...
          {/* Right: Records */}
          <Grid item xs={12} lg={6}>
            <Box sx={{ borderRadius: '20px', overflow: 'hidden', border: `1px solid ${alpha(accentColor, 0.1)}`, animation: 'lruPulse 2s ease-in-out 0.13s infinite' }}>
              ...
              <Box sx={{ p: 4, background: `linear-gradient(135deg, ${primaryColor} 0%, ${secondaryColor} 100%)`, borderBottom: `1px solid ${alpha(accentColor, 0.08)}` }}>
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 2 }}>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                    <Box sx={{ width: 18, height: 18, borderRadius: '4px', bgcolor: alpha(accentColor, 0.15) }} />
                    <SkeletonBox width={35} height={12} borderRadius={3} />
                    {[120, 130, 120].map((w, i) => (
                      <Box key={i} sx={{ width: w, height: 36, borderRadius: '12px', border: `1px solid ${alpha(accentColor, 0.15)}`, bgcolor: 'rgba(255,255,255,0.9)' }} />
                    ))}
                  </Box>
                </Box>
              </Box>
              ...
              <Box sx={{ p: 4, display: 'flex', flexDirection: 'column', gap: 2 }}>
                {[...Array(3)].map((_, i) => (
                  <Box key={i} sx={{ borderRadius: '16px', border: `1px solid ${alpha(accentColor, 0.08)}`, p: 3, bgcolor: 'rgba(255,255,255,0.6)', boxShadow: '0 2px 12px rgba(109,35,35,0.04)', animation: `lruPulse 2s ease-in-out ${i * 0.07}s infinite` }}>
                    <Grid container spacing={2} alignItems="center">

                      {/* Leave Type col */}
                      <Grid item xs={12} md={3}>
                        <SkeletonBox width="55%" height={9} borderRadius={3} sx={{ mb: 0.75 }} />
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 0.5 }}>
                          <Box sx={{ width: 16, height: 16, borderRadius: '4px', bgcolor: alpha(accentColor, 0.15) }} />
                          <SkeletonBox width={44} height={13} borderRadius={3} />
                        </Box>
                      ...
                      {/* Leave Date col */}
                      <Grid item xs={6} md={2}>
                        <SkeletonBox width="60%" height={9} borderRadius={3} sx={{ mb: 0.75 }} />
                        <SkeletonBox width="90%" height={13} borderRadius={3} />
                      </Grid>

                      {/* Submitted col */}
                      <Grid item xs={6} md={3}>
                        <SkeletonBox width="50%" height={9} borderRadius={3} sx={{ mb: 0.75 }} />
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                          <Box sx={{ width: 13, height: 13, borderRadius: '50%', bgcolor: alpha(accentColor, 0.12) }} />
                      ...
                      {/* Status col */}
                      <Grid item xs={6} md={2}>
                        <SkeletonBox width="45%" height={9} borderRadius={3} sx={{ mb: 0.75 }} />
                        <Box sx={{
                          display: 'inline-flex', alignItems: 'center', gap: 0.75,
                          px: 1.5, py: 0.5, borderRadius: '8px', height: 28,
                          bgcolor: i === 0 ? '#FFF8E1' : i === 1 ? '#E3F2FD' : '#E8F5E9',
                          border: `1px solid ${alpha(i === 0 ? '#F57C00' : i === 1 ? '#1565C0' : '#2E7D32', 0.2)}`,
                        }}>
                          <Box sx={{ width: 12, height: 12, borderRadius: '50%', bgcolor: i === 0 ? alpha('#F57C00', 0.4) : i === 1 ? alpha('#1565C0', 0.4) : alpha('#2E7D32', 0.4) }} />
                          <SkeletonBox width={58} height={10} borderRadius={3} />
                        </Box>
                      </Grid>
                      ...
                      <Grid item xs={6} md={2}>
                        {i === 0 && (
                          <Box sx={{ width: 72, height: 32, borderRadius: '10px', border: `1.5px solid ${alpha('#C62828', 0.3)}`, bgcolor: alpha('#C62828', 0.04) }} />
                        )}
                      </Grid>
...
const LeaveRequestUser = () => {
  ...
  const groupedBalances = useMemo(() => {
    ...
    return Object.values(map).map((b) => ({ ...b, totalDays: (b.totalHours / 8).toFixed(1) }));
  ...
  const getAllocatedRemainingDays = () => {
    ...
    const allocated = assignments
      .filter((a) => a.leave_code === newLeaveRequest.leave_code && (a.carried_forward_hours === null || Number(a.carried_forward_hours) === 0))
      .sort((a, b) => {
        if (b.period_year !== a.period_year) return b.period_year - a.period_year;
        const semVal = (s) => { if (!s) return 0; if (s.includes('2nd')) return 2; if (s.includes('1st')) return 1; return 0; };
  ...
  const fetchLeaveTypes = async () => {
    ...
    } catch (e) { console.error('Error fetching leave types:', e); }
  };
  ...
  const fetchAssignments = async () => {
    ...
    try {
      ...
      const mine = (Array.isArray(res.data) ? res.data : []).filter((a) => a.employeeNumber?.toString() === personID?.toString());
      setAssignments(mine);
  ...
  const handleAdd = async () => {
    if (!newLeaveRequest.leave_code) { alert('Please select a leave type.'); return; }
    if (!selectedDates.length) { alert('Please pick at least one leave date.'); return; }
    ...
    if (unavailableDates.length > 0) {
      setUnavailableDatesAlertDetail(`One or more selected dates are unavailable due to existing HR-approved leave. Please change your selection.`);
    ...
    if (remainingDays !== null && selectedDates.length > remainingDays) {
      const typeName = leaveTypes.find((t) => t.leave_code === newLeaveRequest.leave_code)?.leave_description || newLeaveRequest.leave_code;
      setBalanceAlertDetail(`You are requesting ${selectedDates.length} day(s) of "${typeName}" but only have ${remainingDays.toFixed(1)} allocated day(s) remaining.`);
      setBalanceAlertOpen(true);
      return;
    }
    setLoading(true);
    try {
      await axios.post(`${API_BASE_URL}/leaveRoute/leave_request`, { employeeNumber: personID, leave_code: newLeaveRequest.leave_code, leave_dates: selectedDates, status: '0' }, getAuthHeaders());
      ...
      if (err.response?.status === 400) { setBalanceAlertDetail(err.response?.data?.detail || errMsg); setBalanceAlertOpen(true); }
  ...
  const getLeaveTypeInfo = (leaveDesc) =>
    leaveTypes.find((t) => t.leave_description === leaveDesc) || { leave_description: leaveDesc };
  ...
  const handleCancelRequest = async (id) => {
    ...
    try {
      ...
      await axios.put(`${API_BASE_URL}/leaveRoute/leave_request/${id}`, { employeeNumber: req.employeeNumber, leave_code: req.leave_code, leave_date: req.leave_date, status: 4 }, getAuthHeaders());
      setSuccessAction('Request Cancelled Successfully');
      setSuccessOpen(true);
      setTimeout(() => setSuccessOpen(false), 2000);
      await fetchLeaveRequests();
      await fetchAssignments();
    } catch (err) { alert('Error cancelling request: ' + (err.response?.data?.error || err.message)); }
  };

  const getStatusInfo = (status) =>
    ({
      0: { label: 'Pending', sublabel: '', color: '#F57C00', bg: '#FFF8E1', icon: AccessTime },
      1: { label: 'Supervisor Approved', sublabel: 'Pending HR', color: '#1565C0', bg: '#E3F2FD', icon: CheckCircle },
      2: { label: 'HR Approved', sublabel: '', color: '#2E7D32', bg: '#E8F5E9', icon: CheckCircle },
      3: { label: 'Denied', sublabel: '', color: '#C62828', bg: '#FFEBEE', icon: Block },
      4: { label: 'Cancelled', sublabel: '', color: '#757575', bg: '#FAFAFA', icon: CancelIcon },
    })[String(status)] || { label: 'Unknown', sublabel: '', color: '#757575', bg: '#FAFAFA', icon: AccessTime };
  ...
  const renderTransactionMessage = (message) => {
    ...
    const highlights = [];
    if (lower.includes('immediate supervisor')) highlights.push({ pattern: /\bapprove\b/gi, color: '#1565C0' });
    else if (lower.includes('hr') && lower.includes('approve')) highlights.push({ pattern: /\bapprove\b/gi, color: '#2E7D32' });
    ...
    highlights.forEach(({ pattern, color }, idx) => {
      rendered = rendered.flatMap((part, partIdx) => {
        ...
        chunks.forEach((chunk, i) => {
          ...
          if (i < matches.length) out.push(<Box component="span" key={`hl-${idx}-${partIdx}-${i}`} sx={{ color, fontWeight: 700 }}>{matches[i]}</Box>);
        });
        return out;
      });
    });
  ...
  React.useEffect(() => {
    ...
    if (newLeaveRequest.leave_code) {
      const hasAllocation = assignments.some((a) => a.leave_code === newLeaveRequest.leave_code && parseFloat(a.allocated_hours || 0) > 0);
      if (!hasAllocation) setInlineLeaveTypeError(`This request cannot be processed due to insufficient leave balance.`);
      if (remainingDays !== null && selectedDates.length > remainingDays)
        setInlineSelectedDatesError(`You requested ${selectedDates.length} day(s) but only have ${remainingDays.toFixed(1)} allocated day(s) remaining.`);
    }
  }, [newLeaveRequest.leave_code, groupedBalances, remainingDays, selectedDates, leaveTypes]); // eslint-disable-line react-hooks/exhaustive-deps
    ...
    <Fade in timeout={500}>
      <Box sx={{
        ...
        <Box sx={{ px: { xs: 2, sm: 3, md: 6 }, mx: 'auto', maxWidth: '1800px' }}>
          ...
          <Snackbar open={unavailableDatesAlertOpen} onClose={() => setUnavailableDatesAlertOpen(false)} anchorOrigin={{ vertical: 'bottom', horizontal: 'right' }} autoHideDuration={5000} sx={{ zIndex: 9999, mb: { xs: 8, sm: 10, md: 12 } }}>
            <Alert severity="error" onClose={() => setUnavailableDatesAlertOpen(false)} icon={<WarningIcon fontSize="inherit" />} sx={{ width: '100%', maxWidth: 420, borderRadius: 3, background: '#C62828', color: '#fff', boxShadow: '0 8px 32px rgba(198,40,40,0.18)', border: '1.5px solid #C62828', '& .MuiAlert-message': { width: '100%' }, '& .MuiTypography-root': { color: '#fff' } }}>
              <Typography sx={{ fontWeight: 700, fontSize: '1rem', mb: 0.5 }}>Unavailable Leave Date(s)</Typography>
              <Typography variant="body2" sx={{ opacity: 0.95 }}>{unavailableDatesAlertDetail}</Typography>
            </Alert>
          </Snackbar>

          {/* Snackbar: balance alert */}
          <Snackbar open={balanceAlertOpen} onClose={() => setBalanceAlertOpen(false)} anchorOrigin={{ vertical: 'top', horizontal: 'center' }} sx={{ top: { xs: 32, sm: 48 }, zIndex: 9999 }}>
            <Alert severity="error" onClose={() => setBalanceAlertOpen(false)} icon={<WarningIcon fontSize="inherit" />} sx={{ width: '100%', maxWidth: 520, borderRadius: 3, boxShadow: '0 8px 32px rgba(198,40,40,0.25)', border: '1.5px solid rgba(198,40,40,0.3)', '& .MuiAlert-message': { width: '100%' } }}>
              <Typography sx={{ fontWeight: 700, fontSize: '1rem', mb: 0.5 }}>Insufficient Leave Balance</Typography>
              <Typography variant="body2" sx={{ opacity: 0.9 }}>{balanceAlertDetail}</Typography>
            </Alert>
          </Snackbar>
          ...
          <Fade in timeout={600}>
            <GlassCard sx={{ mb: 4, border: `1px solid ${alpha(accentColor, 0.1)}` }}>
              <Box sx={{
                ...
                <Avatar sx={{ bgcolor: alpha(accentColor, 0.12), width: 36, height: 36, mr: 2 }}>
                  <WalletIcon sx={{ color: accentColor, fontSize: 20 }} />
                </Avatar>
                <Box>
                  <Typography variant="h6" sx={{ fontWeight: 700, color: accentColor, lineHeight: 1.2 }}>Your Leave Balances</Typography>
                  <Typography variant="caption" sx={{ color: accentDark, opacity: 0.8 }}>Remaining leave credits per type</Typography>
                </Box>
              </Box>
              <Box sx={{ p: 3, bgcolor: alpha(primaryColor, 0.4) }}>
                {groupedBalances.length === 0 ? (
                  <Typography align="center" sx={{ py: 3, color: '#666' }}>No balance information available.</Typography>
                ) : (
                  <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1.5 }}>
                    {groupedBalances.map((balance) => {
                      const maxAssignment = assignments.filter((a) => a.leave_code === balance.code).reduce((max, a) => { const days = parseFloat(a.allocated_hours || 0) / 8; return days > max ? days : max; }, 0);
                      const pct = maxAssignment > 0 ? Math.min(100, (balance.totalDays / maxAssignment) * 100) : 0;
                      const barColor = pct > 60 ? '#2E7D32' : pct > 30 ? '#F57C00' : '#C62828';
                      return (
                        <BalanceCard key={balance.code}>
                          {/* left: code chip + description */}
                          <Box>
                            <Chip label={balance.code} size="small" sx={{ bgcolor: alpha(accentColor, 0.1), color: accentColor, fontWeight: 700, fontSize: '0.7rem', height: 20, mb: 0.5 }} />
                            <Typography variant="caption" sx={{ display: 'block', color: '#666', fontSize: '0.72rem', maxWidth: 110, lineHeight: 1.3 }}>{balance.description}</Typography>
                          </Box>
                          {/* divider */}
                          <Box sx={{ width: '1px', height: 32, bgcolor: alpha(accentColor, 0.12), flexShrink: 0 }} />
                          {/* right: days + bar */}
                          <Box>
                            <Typography sx={{ fontWeight: 700, color: textPrimaryColor, fontSize: '1rem', lineHeight: 1 }}>
                              {balance.totalDays}
                              <Typography component="span" sx={{ color: '#999', fontWeight: 400, fontSize: '0.75rem', ml: 0.5 }}>/ {maxAssignment.toFixed(1)} d</Typography>
                            </Typography>
                            <Box sx={{ mt: 0.75, height: 3, width: 72, bgcolor: '#e8e8e8', borderRadius: 2 }}>
                              <Box sx={{ height: '100%', width: `${pct}%`, bgcolor: barColor, borderRadius: 2, transition: 'width 0.6s ease' }} />
                            </Box>
                          </Box>
                        </BalanceCard>
                      );
          ...
          <Grid container spacing={4}>
            ...
            <Grid item xs={12} lg={6}>
              <Fade in timeout={700}>
                <GlassCard sx={{ height: '100%', border: `1px solid ${alpha(accentColor, 0.1)}` }}>
                  <Box sx={{
                    p: 4,
                    background: `linear-gradient(135deg, ${primaryColor} 0%, ${secondaryColor} 100%)`,
                    color: accentColor,
                    ...
                    <Box>
                      <Typography variant="h6" sx={{ fontWeight: 700, color: accentColor, lineHeight: 1.2 }}>Submit New Leave Request</Typography>
                      <Typography variant="caption" sx={{ color: accentDark, opacity: 0.8 }}>Fill in the details to request leave</Typography>
                    </Box>
                  </Box>
                  ...
                  <Box sx={{ p: 4 }}>
                    <Grid container spacing={3}>
                      ...
                      <Grid item xs={12}>
                        ...
                        <ModernTextField
                          value={personID} disabled fullWidth size="small"
                          sx={{ '& .MuiInputBase-input.Mui-disabled': { WebkitTextFillColor: '#333' } }}
                        />
                      </Grid>

                      {/* Leave Type */}
                      <Grid item xs={12}>
                        <Typography variant="body2" sx={{ fontWeight: 600, mb: 1, color: accentColor }}>Leave Type <Box component="span" sx={{ color: '#C62828' }}>*</Box></Typography>
                        <FormControl fullWidth size="small">
                          <ModernSelect value={newLeaveRequest.leave_code} onChange={(e) => handleChange('leave_code', e.target.value)} displayEmpty>
                            <MenuItem value=""><em style={{ color: '#999' }}>Select Leave Type</em></MenuItem>
                            {leaveTypes.map((type) => (
                              <MenuItem key={type.id} value={type.leave_code}>
                                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                  <Chip label={type.leave_code} size="small" sx={{ bgcolor: alpha(accentColor, 0.1), color: accentColor, fontWeight: 700, fontSize: '0.7rem', height: 20 }} />
                                  <Typography variant="body2">{type.leave_description}</Typography>
                                </Box>
                              </MenuItem>
                            ))}
                          </ModernSelect>
                        ...
                        {inlineLeaveTypeError && (
                          <Alert severity="error" icon={<WarningIcon fontSize="inherit" />} sx={{ mt: 1, fontSize: '0.85rem', py: 0.5, px: 2, borderRadius: 2, bgcolor: 'rgba(198,40,40,0.06)', border: '1px solid rgba(198,40,40,0.2)' }}>
                            {inlineLeaveTypeError}
                          </Alert>
                        )}
                      </Grid>
                      ...
                      {newLeaveRequest.leave_code && remainingDays !== null && isOverBalance && (
                        <Grid item xs={12}>
                          <Box sx={{ px: 2, py: 1.5, borderRadius: 2, bgcolor: 'rgba(198,40,40,0.06)', border: '1.5px solid rgba(198,40,40,0.25)', display: 'flex', alignItems: 'center', gap: 1.5 }}>
                            <WarningIcon sx={{ color: '#C62828', fontSize: 20, flexShrink: 0 }} />
                      ...
                      <Grid item xs={12}>
                        ...
                        <ProfessionalButton
                          ...
                          sx={{
                            ...
                            bgcolor: alpha(isOverBalance ? '#C62828' : accentColor, 0.04),
                            '&:hover': { bgcolor: alpha(isOverBalance ? '#C62828' : accentColor, 0.08), border: `1.5px solid ${isOverBalance ? '#C62828' : accentColor}` },
                          }}
                        >
                        ...
                        <LeaveDatePicker
                          open={dateModalOpen}
                          onClose={() => { setNewLeaveRequest((prev) => ({ ...prev, leave_date: selectedDates.join(',') })); setDateModalOpen(false); }}
                          ...
                          allowPastDates={isSickLeave()} leaveType={newLeaveRequest.leave_code}
                          leaveRequests={leaveRequests} maxSelectableDates={remainingDays}
                        />
                        {isSickLeave() && (
                          <Typography variant="caption" sx={{ color: '#1565C0', mt: 0.5, display: 'block', fontStyle: 'italic' }}>
                      ...
                      <Grid item xs={12}>
                        <Typography variant="body2" sx={{ fontWeight: 600, mb: 1, color: accentColor }}>Selected Dates</Typography>
                        <Box sx={{
                          minHeight: 56, display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: 1, p: 2,
                          border: `1px solid ${alpha(isOverBalance ? '#C62828' : accentColor, 0.2)}`,
                          borderRadius: 3, backgroundColor: alpha(primaryColor, 0.5),
                        }}>
                            ...
                            selectedDates.map((date) => {
                              ...
                              const chip = (
                                <Chip
                                  ...
                                  sx={{
                                    bgcolor: isHRApproved ? alpha('#C62828', 0.12) : alpha('#2E7D32', 0.12),
                                    color: isHRApproved ? '#C62828' : '#2E7D32',
                                    fontWeight: 600, fontSize: '0.82rem', height: 30,
                              ...
                              return isHRApproved ? (
                                <Tooltip key={date} title="This date is unavailable. An HR-approved leave has already been scheduled." arrow><span>{chip}</span></Tooltip>
                              ) : chip;
                            })
                          ) : (
                            <Typography variant="body2" sx={{ color: '#aaa', fontStyle: 'italic' }}>No dates selected</Typography>
                          )}
                        </Box>
                      </Grid>
                      ...
                      <Grid item xs={12}>
                        <ProfessionalButton
                          ...
                          sx={{
                            ...
                            color: isOverBalance || remainingDays === 0 ? '#666' : textSecondaryColor,
                            boxShadow: isOverBalance || remainingDays === 0 ? 'none' : `0 4px 14px ${alpha(accentColor, 0.35)}`,
                            '&:hover': {
                              backgroundColor: isOverBalance || remainingDays === 0 ? '#ccc' : accentDark,
                              boxShadow: isOverBalance || remainingDays === 0 ? 'none' : `0 6px 20px ${alpha(accentColor, 0.45)}`,
                            },
                            '&:disabled': { backgroundColor: '#ccc !important', color: '#666 !important' },
                          }}
                        >
                          {remainingDays === 0 ? 'No Balance — Cannot Submit' : isOverBalance ? 'Insufficient Balance — Cannot Submit' : 'Submit Leave Request'}
                        </ProfessionalButton>
                      </Grid>
            ...
            <Grid item xs={12} lg={6}>
              <Fade in timeout={900}>
                <GlassCard sx={{ height: '100%', border: `1px solid ${alpha(accentColor, 0.1)}`, display: 'flex', flexDirection: 'column' }}>
                  <Box sx={{
                    p: 4,
                    background: `linear-gradient(135deg, ${primaryColor} 0%, ${secondaryColor} 100%)`,
                    borderBottom: `1px solid ${alpha(accentColor, 0.08)}`,
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 2.5 }}>
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, flexWrap: 'wrap' }}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                          ...
                          <Typography variant="body2" sx={{ fontWeight: 600, color: accentColor, fontSize: '0.8rem' }}>Filter:</Typography>
                        </Box>
                        <FormControl size="small" sx={{ minWidth: 120 }}>
                          <ModernSelect value={monthFilter} onChange={(e) => setMonthFilter(e.target.value)} displayEmpty renderValue={(v) => v ? months.find((m) => m.value === v)?.label : 'Month'}>
                            {months.map((m) => <MenuItem key={m.value} value={m.value}>{m.label}</MenuItem>)}
                          </ModernSelect>
                        </FormControl>
                        <FormControl size="small" sx={{ minWidth: 130 }}>
                          <ModernSelect value={leaveTypeFilter} onChange={(e) => setLeaveTypeFilter(e.target.value)} displayEmpty renderValue={(v) => v || 'Leave Type'}>
                            <MenuItem value=""><em>All Types</em></MenuItem>
                            {leaveTypes.map((t) => <MenuItem key={t.id} value={t.leave_code}>{t.leave_code}</MenuItem>)}
                          </ModernSelect>
                        </FormControl>
                        <FormControl size="small" sx={{ minWidth: 120 }}>
                          <ModernSelect value={statusFilter} onChange={(e) => setStatusFilter(e.target.value)} displayEmpty renderValue={(v) => v ? statusOptions.find((s) => s.value === v)?.label : 'Status'}>
                  ...
                  <Box sx={{
                    p: 4, flexGrow: 1, maxHeight: 480, overflowY: 'auto',
                    '&::-webkit-scrollbar': { width: 6 },
                    '&::-webkit-scrollbar-track': { background: alpha(primaryColor, 0.5), borderRadius: 3 },
                    '&::-webkit-scrollbar-thumb': { background: alpha(accentColor, 0.4), borderRadius: 3, '&:hover': { background: accentColor } },
                  }}>
                    {filteredLeaveRequests.length === 0 ? (
                      <Box sx={{ textAlign: 'center', py: 8 }}>
                        <EventNote sx={{ fontSize: 56, color: alpha(accentColor, 0.2), mb: 2 }} />
                        <Typography variant="h6" sx={{ color: alpha(accentColor, 0.6), fontWeight: 600 }}>No Leave Requests Found</Typography>
                      ...
                      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                        {filteredLeaveRequests.map((leaveRequest) => {
                          const typeInfo = getLeaveTypeInfo(leaveRequest.leave_description);
                            ...
                            <RecordCard key={leaveRequest.id}>
                              <CardContent sx={{ p: 3, '&:last-child': { pb: 3 } }}>
                                <Grid container spacing={2} alignItems="center">
                                  ...
                                  {/* Leave type */}
                                  <Grid item xs={12} md={3}>
                                    <Typography variant="caption" sx={{ color: '#999', display: 'block', mb: 0.5, textTransform: 'uppercase', letterSpacing: '0.05em', fontSize: '0.7rem' }}>Leave Type</Typography>
                                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 0.25 }}>
                                      <EventNote sx={{ fontSize: 16, color: accentColor }} />
                                      <Typography variant="body2" sx={{ fontWeight: 700, color: accentColor }}>{typeInfo.leave_code || leaveRequest.leave_code}</Typography>
                                    </Box>
                                    <Typography variant="caption" sx={{ color: '#777', fontSize: '0.75rem' }}>{typeInfo.leave_description}</Typography>
                                  </Grid>

                                  {/* Leave date */}
                                  <Grid item xs={6} md={2}>
                                    <Typography variant="caption" sx={{ color: '#999', display: 'block', mb: 0.5, textTransform: 'uppercase', letterSpacing: '0.05em', fontSize: '0.7rem' }}>Leave Date</Typography>
                                    <Typography variant="body2" sx={{ fontWeight: 600, color: '#333' }}>{formatDate(leaveRequest.leave_date)}</Typography>
                                  </Grid>
                                  ...
                                  <Grid item xs={12} md={4}>
                                    <Typography variant="caption" sx={{ color: '#999', display: 'block', mb: 0.5, textTransform: 'uppercase', letterSpacing: '0.05em', fontSize: '0.7rem' }}>Status</Typography>
                                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, flexWrap: 'wrap' }}>
                                      <Box sx={{ display: 'inline-flex', alignItems: 'center', gap: 0.75, px: 1.5, py: 0.5, borderRadius: 2, bgcolor: statusInfo.bg, border: `1px solid ${alpha(statusInfo.color, 0.2)}` }}>
                                        <StatusIcon sx={{ fontSize: 14, color: statusInfo.color }} />
                                        <Typography variant="body2" sx={{ fontWeight: 600, color: statusInfo.color, fontSize: '0.78rem', whiteSpace: 'nowrap' }}>{statusInfo.label}</Typography>
                                      </Box>
                                      {canCancel && (
                                        <ProfessionalButton
                                          size="small"
                                          variant="outlined"
                                          onClick={() => handleCancelRequest(leaveRequest.id)}
                                          sx={{
                                            color: '#C62828', borderColor: alpha('#C62828', 0.3), fontSize: '0.75rem', py: 0.5, px: 1.5, minWidth: 0,
                                            '&:hover': { backgroundColor: alpha('#C62828', 0.08), borderColor: '#C62828' },
                                          }}
                                        >
                                          Cancel
                                        </ProfessionalButton>
                                    ...
                                    {statusInfo.sublabel && (
                                      <Typography variant="caption" sx={{ color: '#888', display: 'block', mt: 0.25 }}>{statusInfo.sublabel}</Typography>
                                    )}
                                  </Grid>
          ...
          <Fade in={showScrollTop}>
            <Box
              ...
              sx={{
                ...
                cursor: 'pointer', boxShadow: `0 4px 14px ${alpha(accentColor, 0.4)}`,
                transition: 'all 0.3s ease',
                '&:hover': { bgcolor: accentDark, transform: 'translateY(-2px)', boxShadow: `0 6px 20px ${alpha(accentColor, 0.5)}` },
              }}
            >
              <KeyboardArrowUp />
            </Box>
