...
const InfoRow = ({ label, value, color }) => (
  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', py: 0.75, borderBottom: '1px solid rgba(0,0,0,0.05)' }}>
    <Typography variant="caption" sx={{ color: '#888', fontWeight: 700 }}>{label}</Typography>
    <Typography variant="body2" sx={{ fontWeight: 800, color: color || '#333' }}>{value}</Typography>
  </Box>
);
...
const LCSkeletonBox = ({ width = '100%', height = 16, borderRadius = 8, sx = {} }) => (
  <Box sx={{
    width, height,
...
const LeaveCommutationWireframe = () => (
  <>
    ...
    <Box sx={{ py: { xs: 2, md: 4 }, mt: { xs: 0, md: -5 }, width: '100vw', maxWidth: '100%', position: 'relative', left: '63%', transform: 'translateX(-61%)', px: { xs: 2, sm: 3, md: 6 } }}>
      ...
      <Box sx={{ mb: 4, borderRadius: '12px', overflow: 'hidden', border: '1px solid rgba(109,35,35,0.1)', animation: 'lcPulse 2s ease-in-out infinite' }}>
        <Box sx={{ p: 5, background: 'linear-gradient(135deg,#FFFFFF 0%,#F5F5F5 100%)', position: 'relative', overflow: 'hidden' }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', position: 'relative', zIndex: 1 }}>
            ...
            <Box>
              <LCSkeletonBox width={280} height={28} borderRadius={6} sx={{ mb: 1.5 }} />
      ...
      <Grid container spacing={2} sx={{ mb: 4 }}>
        {[
          ...
          <Grid item xs={6} md={3} key={i}>
            <Box sx={{
              borderRadius: '12px', border: '1px solid rgba(109,35,35,0.08)',
              bgcolor: '#fff', p: 2.5, display: 'flex', alignItems: 'center', gap: 2,
              animation: `lcPulse 2s ease-in-out ${i * 0.08}s infinite`,
            }}>
              <Box sx={{ width: 52, height: 52, borderRadius: '50%', bgcolor: avatarColor, flexShrink: 0 }} />
              <Box sx={{ flexGrow: 1 }}>
                <LCSkeletonBox width={52} height={22} borderRadius={4} sx={{ mb: 0.75 }} />
      ...
      <Box sx={{ borderRadius: '12px', overflow: 'hidden', border: '1px solid rgba(109,35,35,0.1)', bgcolor: '#fff', animation: 'lcPulse 2s ease-in-out 0.2s infinite' }}>

        {/* Toolbar */}
        <Box sx={{
          p: 4, background: 'linear-gradient(135deg,#FFFFFF 0%,#F5F5F5 100%)',
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            ...
            <Box>
              <LCSkeletonBox width={210} height={16} borderRadius={4} sx={{ mb: 0.75 }} />
              <LCSkeletonBox width={130} height={11} borderRadius={3} />
            </Box>
          </Box>
          <Box sx={{ display: 'flex', gap: 1.5, alignItems: 'center' }}>
            <Box sx={{ width: 260, height: 40, borderRadius: '8px', border: '1px solid rgba(109,35,35,0.15)', bgcolor: '#fff', display: 'flex', alignItems: 'center', px: 1.5, gap: 1 }}>
              <Box sx={{ width: 18, height: 18, borderRadius: '50%', bgcolor: 'rgba(109,35,35,0.12)', flexShrink: 0 }} />
              <LCSkeletonBox width="55%" height={11} borderRadius={3} />
            </Box>
            <Box sx={{ width: 150, height: 40, borderRadius: '8px', border: '1px solid rgba(109,35,35,0.15)', bgcolor: '#fff', display: 'flex', alignItems: 'center', px: 1.5 }}>
        ...
        {/* Column headers */}
        <Box sx={{ display: 'grid', gridTemplateColumns: '2.5fr 1fr 1fr 1.3fr 1fr', gap: 2, px: 4, py: 1.5, bgcolor: 'rgba(109,35,35,0.04)', borderBottom: '1px solid rgba(109,35,35,0.08)' }}>
        ...
        {[...Array(8)].map((_, i) => (
          <Box key={i} sx={{
            ...
            px: 4, py: 2.25, alignItems: 'center',
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
              <Box sx={{ width: 38, height: 38, borderRadius: '8px', bgcolor: 'rgba(109,35,35,0.15)', flexShrink: 0 }} />
              <Box>
                <LCSkeletonBox width={130} height={12} borderRadius={3} sx={{ mb: 0.5 }} />
                <LCSkeletonBox width={72} height={9} borderRadius={2} />
              </Box>
            </Box>
            {/* Leave Code chip */}
            <Box sx={{ width: 48, height: 24, borderRadius: '6px', bgcolor: 'rgba(109,35,35,0.08)', border: '1px solid rgba(109,35,35,0.12)' }} />
            {/* Period */}
            <LCSkeletonBox width={64} height={11} borderRadius={3} />
            {/* Days/Hours */}
            <Box>
              <LCSkeletonBox width={95} height={14} borderRadius={3} sx={{ mb: 0.4 }} />
              <LCSkeletonBox width={60} height={9} borderRadius={2} />
            </Box>
            {/* Date */}
            <Box>
              <LCSkeletonBox width={78} height={11} borderRadius={3} sx={{ mb: 0.4 }} />
  ...
  return (
    <Box sx={{ py: { xs: 2, md: 4 }, mt: { xs: 0, md: -5 }, width: '100vw', maxWidth: '100%', position: 'relative', left: '63%', transform: 'translateX(-61%)', px: { xs: 2, sm: 3, md: 6 } }}>
          ...
          <Grid item xs={6} md={3} key={label}>
            <GlassCard>
              <Box sx={{ p: 2.5, display: 'flex', alignItems: 'center', gap: 2 }}>
                <Avatar sx={{ bgcolor: `${color}18`, width: 52, height: 52, boxShadow: `0 4px 12px ${color}25` }}>
                  {React.cloneElement(icon, { sx: { color, fontSize: 26 } })}
                </Avatar>
                <Box>
                  <Typography sx={{ fontWeight: 900, color, fontSize: '1.5rem', lineHeight: 1, fontVariantNumeric: 'tabular-nums' }}>{value}</Typography>
                  <Typography variant="caption" sx={{ color: '#888', fontWeight: 700, letterSpacing: 0.2 }}>{label}</Typography>
                </Box>
              </Box>
            </GlassCard>
          </Grid>
      ...
      <GlassCard sx={{ mb: { xs: 6, md: 10 }, overflow: 'visible' }}>
        ...
        <Box sx={{
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            ...
            <Box>
              <Typography variant="h6" sx={{ fontWeight: 900, color: '#6d2323' }}>Commutation Records</Typography>
              <Typography variant="body2" sx={{ color: '#8B3333', fontWeight: 800, opacity: 0.85 }}>
          ...
          <Box sx={{ display: 'flex', gap: 1.5, flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            <FormControl size="small" sx={{ minWidth: 150 }}>
              <InputLabel sx={{ color: '#6d2323', fontWeight: 700, '&.Mui-focused': { color: '#6d2323' } }}>Leave Type</InputLabel>
              <Select
                value={filterLeave}
                ...
                sx={{
                  ...
                  '&.Mui-focused .MuiOutlinedInput-notchedOutline': { borderColor: '#6d2323' },
                }}
              >
        ...
        <CardContent sx={{ p: 0, overflow: 'visible' }}>
          {filtered.length === 0 ? (
            <Box sx={{ textAlign: 'center', py: 12 }}>
              <Box sx={{ width: 100, height: 100, borderRadius: '50%', bgcolor: 'rgba(109,35,35,0.05)', display: 'flex', alignItems: 'center', justifyContent: 'center', mx: 'auto', mb: 3 }}>
                <CommutationIcon sx={{ fontSize: 52, color: 'rgba(109,35,35,0.25)' }} />
              </Box>
              <Typography variant="h6" sx={{ color: '#6d2323', fontWeight: 900, mb: 1 }}>
                {records.length === 0 ? 'No Commutation Records Yet' : 'No Matching Records'}
              </Typography>
              <Typography variant="body2" sx={{ color: '#888', fontWeight: 700, maxWidth: 420, mx: 'auto' }}>
                {records.length === 0
            ...
            <Box>
              ...
              <Box sx={{
                ...
                {['Employee', 'Leave Code', 'Period', 'Days / Hours Commuted', 'Date'].map((h) => (
                  <Typography key={h} variant="caption" sx={{ fontWeight: 900, color: '#6d2323', textTransform: 'uppercase', letterSpacing: 0.6, fontSize: '0.68rem' }}>
                    {h}
                  </Typography>
                ))}
              </Box>
              ...
              {filtered.map((rec, idx) => (
                <Box
                  ...
                  sx={{
                    display: 'grid', gridTemplateColumns: '2.5fr 1fr 1fr 1.3fr 1fr', gap: 2,
                    px: 4, py: 2.25, cursor: 'pointer', alignItems: 'center',
                    borderBottom: idx < filtered.length - 1 ? '1px solid rgba(0,0,0,0.05)' : 'none',
                    bgcolor: idx % 2 === 0 ? '#fff' : 'rgba(109,35,35,0.012)',
                    transition: 'all 0.2s ease',
                    '&:hover': { bgcolor: 'rgba(109,35,35,0.05)', transform: 'translateX(3px)', boxShadow: 'inset 3px 0 0 #6d2323' },
                  }}
                >
                  {/* Employee */}
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                    <Avatar sx={{ bgcolor: '#6d2323', width: 38, height: 38, fontSize: '0.8rem', fontWeight: 900, borderRadius: '8px' }}>
                      {(rec.firstName?.[0] || rec.fullName?.[0] || '?').toUpperCase()}{(rec.lastName?.[0] || '').toUpperCase()}
                    </Avatar>
                    <Box>
                      <Typography variant="body2" sx={{ fontWeight: 800, color: '#1a1a1a', lineHeight: 1.25 }}>
                        {rec.fullName || rec.employeeNumber}
                      </Typography>
                      <Typography variant="caption" sx={{ color: '#aaa', fontWeight: 600 }}>#{rec.employeeNumber}</Typography>
                    </Box>
                  </Box>
                  ...
                  <Chip
                    ...
                    sx={{ bgcolor: 'rgba(109,35,35,0.08)', color: '#6d2323', fontWeight: 900, fontSize: '0.75rem', width: 'fit-content', borderRadius: '6px', border: '1px solid rgba(109,35,35,0.15)' }}
                  />
                  ...
                  {/* Days / Hours */}
                  <Box>
                    <Typography sx={{ fontWeight: 900, color: '#6d2323', fontSize: '1rem', lineHeight: 1.25 }}>
                  ...
                  <Box>
                    ...
                    {rec.commuted_by && (
                      <Typography variant="caption" sx={{ color: '#aaa', fontWeight: 600 }}>by {rec.commuted_by}</Typography>
                    )}
                  </Box>
                </Box>
              ))}
      ...
      <Modal open={!!selectedRecord} onClose={handleClose} sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', p: 2 }}>
        <Box sx={{ backgroundColor: '#fff', borderRadius: 4, width: '90%', maxWidth: 580, maxHeight: '85vh', overflowY: 'auto', boxShadow: '0 20px 60px rgba(0,0,0,0.2)' }}>
          {selectedRecord && (
            <>
              {/* Modal Header */}
              <Box sx={{
              ...
              <Box sx={{ p: 3 }}>
                ...
                <Box sx={{
                  ...
                  <Box>
                    <Typography variant="caption" sx={{ color: '#888', fontWeight: 800, display: 'block', mb: 0.25, textTransform: 'uppercase', letterSpacing: 0.4, fontSize: '0.65rem' }}>
                      Total Commuted
                    </Typography>
                    <Typography sx={{ fontWeight: 900, color: '#6d2323', fontSize: '2rem', lineHeight: 1 }}>
                      {toNum(selectedRecord.commuted_days).toFixed(2)}
                      <Typography component="span" sx={{ fontSize: '1rem', fontWeight: 700, ml: 0.75 }}>days</Typography>
                    </Typography>
                    <Typography variant="caption" sx={{ color: '#999', fontWeight: 700 }}>
                  ...
                  <Box sx={{ textAlign: 'right' }}>
                    <Typography variant="caption" sx={{ color: '#888', display: 'block', mb: 0.5, fontWeight: 800, textTransform: 'uppercase', letterSpacing: 0.4, fontSize: '0.65rem' }}>Period</Typography>
                    <Typography sx={{ fontWeight: 900, color: '#333', fontSize: '1.1rem' }}>
                    ...
                    <Chip
                      ...
                      sx={{ mt: 0.75, bgcolor: 'rgba(109,35,35,0.1)', color: '#6d2323', fontWeight: 900, borderRadius: '6px', border: '1px solid rgba(109,35,35,0.2)' }}
                    />
                  </Box>
                </Box>

                {/* Details */}
                <Box sx={{ bgcolor: 'rgba(109,35,35,0.02)', borderRadius: 2, border: '1px solid rgba(109,35,35,0.08)', p: 2.5, mb: 3 }}>
                  <Typography variant="subtitle2" sx={{ fontWeight: 900, color: '#6d2323', mb: 1.5, letterSpacing: 0.2 }}>Commutation Details</Typography>
                ...
                <Divider sx={{ my: 2.5 }}>
                  <Chip label="Notes & Approval" size="small" sx={{ bgcolor: 'rgba(109,35,35,0.08)', color: '#6d2323', fontWeight: 800, border: '1px solid rgba(109,35,35,0.15)' }} />
                </Divider>
                ...
                {isEditing ? (
                  <Grid container spacing={2}>
                    <Grid item xs={12}>
                      <TextField
                        ...
                        sx={{
                          '& .MuiOutlinedInput-root': { borderRadius: 2, '& fieldset': { borderColor: 'rgba(109,35,35,0.2)' }, '&:hover fieldset': { borderColor: '#6d2323' }, '&.Mui-focused fieldset': { borderColor: '#6d2323' } },
                  ...
                  <Box sx={{ bgcolor: 'rgba(109,35,35,0.02)', borderRadius: 2, border: '1px solid rgba(109,35,35,0.08)', p: 2 }}>
                  ...
                  {isEditing ? (
                    <>
                      <Button
                        ...
                        sx={{ borderColor: '#6d2323', color: '#6d2323', borderRadius: 2, fontWeight: 900, px: 3, '&:hover': { bgcolor: 'rgba(109,35,35,0.05)' } }}
                      >Cancel</Button>
                      <Button
                        onClick={handleUpdate}
                        variant="contained" startIcon={<SaveIcon />}
                        sx={{ bgcolor: '#6d2323', color: '#fff', borderRadius: 2, fontWeight: 900, px: 3, boxShadow: '0 4px 12px rgba(109,35,35,0.3)', '&:hover': { bgcolor: '#5a1d1d' } }}
                      >Save</Button>
                    </>
                  ) : (
                    <Button
