...
const PermissionToTeach = () => {
  ...
  const ensureCaptureStyles = (el) => {
    ...
    // Force width to capture the full form area (slightly wider than 8in to be safe)
  ...
  const printPage = async () => {
    ...
    try {
      ...
      // Create PDF with Legal Long size to match the layout (8.5 x 13.5)
      ...
      // Dimensions matching the custom legal size used in the layout
      const formWidth = 8.5;
      ...
      // Ratio calculation to fit the form exactly onto the page
      ...
      <Box sx={{ width: '100%', overflow: 'auto', paddingBottom: '100px' }}>
        <div
          ...
          style={{
            ...
            // ✅ keep your current properties
            fontFamily: 'Arial, Helvetica, sans-serif',
            margin: 'auto',
            marginTop: '30px', // Adjusted for container
            backgroundColor: '#ffffff',
          }}
        >
