    ...
    return (
      <>
        ...
        >
          ...
          <SectionCard
            sx={{ animation: 'payrollPulse 2s ease-in-out infinite' }}
          >
            <Box
              sx={{
                px: 3.5,
              ...
              <TableHead>
                <TableRow sx={{ bgcolor: '#fff' }}>
                  ...
                  <TableCell
                    rowSpan={2}
                    align="center"
                    sx={{ ...stickyStatusHeaderSx, fontSize: '0.72rem' }}
                  >
                    Status
                  </TableCell>
                  <TableCell
                    rowSpan={2}
                    align="center"
                    sx={{ ...stickyActionsHeaderSx, fontSize: '0.72rem' }}
                  >
                    Actions
                  </TableCell>
                </TableRow>
              ...
              >
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                  ...
                  <Box>
                    ...
                    >
                      Employee #{editRow.employeeNumber} • View:{' '}
                      {editModalContext.replace('_', ' ')}
                    </Typography>
                  </Box>
                </Box>
              </Box>
                  ...
                  {[
                    ...
                    },
                    {
                      ...
                      fields: [
                        ...
                        { label: 'GFAL', value: editRow.gfal || '0.00' },
                        {
                          label: 'GSIS Arrears',
        ...
        >
          ...
          <Box sx={{ p: 3 }}>
            ...
            >
              ...
              >
                Process {selectedRows.length} Payroll Record(s)
              </Typography>
              <Typography
            ...
            >
              ...
              <Box>
                ...
                >
                  All information is accurate and ready for processing. This
              ...
              <AccentButton
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    setLoading(false);
                    alert(
                      'Failed to process payroll records. Please try again.',
                    );
                  }
                }}
                sx={{
