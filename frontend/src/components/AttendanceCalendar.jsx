    ...
    <Fade in timeout={500}>
      <Box sx={{ width: "100vw", maxWidth: "100%", position: "relative", left: "55%", transform: "translateX(-53.5%)" }}>
        ...
        <Box sx={{ py: -1, px: { xs: -5, sm: -5, md: -5 }, mx: "auto" }}>
          ...
          {/* ── MAIN GRID ── */}
          <Grid container spacing={2} sx={{ flex: 1, minHeight: 0, minWidth: 0, overflow: "hidden" }}>

            {/* ══ LEFT COLUMN ══ */}
            <Grid item xs={12} md={7} sx={{ display: "flex", flexDirection: "column", gap: 2, minHeight: 0, overflow: "hidden", minWidth: 0 }}>
